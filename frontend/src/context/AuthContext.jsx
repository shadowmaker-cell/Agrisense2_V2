      ...
      <div style={styles.card}>
        ...
        {tab === 'login' && (
          <form onSubmit={handleLogin} style={styles.form}>
            ...
            {msg && <div style={{...styles.msg, color: msgType === 'success' ? '#22c55e' : '#f87171', background: msgType === 'success' ? 'rgba(34,197,94,0.08)' : 'rgba(248,113,113,0.08)'}}>{msg}</div>}
        ...
        {tab === 'registro' && (
          <form onSubmit={handleRegistro} style={styles.form}>
            ...
            <div style={styles.fieldGroup}>
              <label style={styles.label}>Celular colombiano * <span style={styles.hint}>10 digitos, ej: 3001234567</span></label>
            ...
            <div style={styles.fieldGroup}>
              <label style={styles.label}>Contrasena * <span style={styles.hint}>Min 8 chars, mayuscula, numero y caracter especial</span></label>
            ...
            <div style={styles.fieldGroup}>
              ...
              <input type="password" placeholder="Repite tu contrasena" value={regForm.confirmar_password}
            ...
            <div style={styles.checkCard}>
              <div style={styles.checkRow}>
                <input type="checkbox" id="tratamiento" checked={regForm.acepta_tratamiento}
              ...
              <div style={styles.checkRow}>
                <input type="checkbox" id="terminos" checked={regForm.acepta_terminos}
