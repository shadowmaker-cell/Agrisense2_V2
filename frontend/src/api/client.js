...
export const ingestaAPI = {
  ...
  ultimasLecturas: (id_logico, limite=10) => api.get(`/ingesta/api/v1/telemetria/ultimas/${id_logico}?limite=${limite}`),
...
export const procesamientoAPI = {
  ...
  eventosSensor:  (id_logico) => api.get(`/procesamiento/api/v1/procesamiento/eventos/${id_logico}`),
